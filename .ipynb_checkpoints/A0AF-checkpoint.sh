...
python A0AF.py train_TFT -exp_name 'A0AF_MOD_sownarea_RMSE_CustomLR' -predicted_years "2005 2010 2017" -batch_size 128 -learning_rate 0.0001 -loss_func_metric 'RMSE' -max_epochs 180
