...
python A0B.py train_TFT -exp_name 'A0B_RMSE_autoresume' -predicted_years "2005 2010 2017" -batch_size 128 -learning_rate 0.01 -loss_func_metric 'RMSE' -max_epochs 200
