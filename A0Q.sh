...
python A0Q.py train_TFT -exp_name 'A0Q3_corn' -predicted_years "2005" -batch_size 128 -learning_rate 0.0001 -loss_func_metric 'RMSE' -max_epochs 2550 -crop_name 'corn'
