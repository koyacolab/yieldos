...
python A0Q.py train_TFT -exp_name 'AQ0TEST_corn' -predicted_years "2018" -batch_size 512 -learning_rate 0.0001 -loss_func_metric 'QuantileLoss' -max_epochs 250 -crop_name 'corn'
