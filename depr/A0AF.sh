...
python A0AF.py train_TFT -exp_name 'A0AF_famine' -predicted_years "2005" -batch_size 128 -learning_rate 0.0001 -loss_func_metric 'RMSE' -max_epochs 1500 -crop_name 'rice'
