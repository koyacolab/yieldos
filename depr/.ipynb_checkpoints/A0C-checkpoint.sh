...
python A0C.py train_TFT -exp_name 'A0C_QuantileLoss' -predicted_years "2005 2010 2017" -batch_size 96 -learning_rate 0.01 -loss_func_metric 'QuantileLoss' -max_epochs 200
