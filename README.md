...
As a result, XGBoost using ([SKForecast](https://skforecast.org/)) techniques have been proposed for the preparation of time series histograms, and the corresponding code is available in the XGBoost folder.
