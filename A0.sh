...
python A0.py train_TFT -exp_name 'A05_test' -predicted_years "2005" -batch_size 128 -learning_rate 0.0001 -loss_func_metric 'RMSE' -max_epochs 1550 -crop_name 'rice'
