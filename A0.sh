...
python A0.py train_TFT -exp_name 'A45_corn' -predicted_years "2018" -batch_size 512 -learning_rate 0.0001 -loss_func_metric 'QuantileLoss' -max_epochs 5550 -crop_name 'corn'
